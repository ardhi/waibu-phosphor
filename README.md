...
Phosphor icons for [Waibu Web Framework](https://github.com/ardhi/waibu)
...
```bash
$ npm install waibu-phosphor waibu-mpa waibu
```

Next, open the file located at ```{data-dir}/config/.plugins``` and add ```waibu-phosphor``` , ```waibu-mpa``` and ```waibu```

## Documentations

- [Config Object](tutorial/00-config.md)
- [API](https://ardhi.github.io/waibu-phosphor)
